...
final class Game {
    ...
    private func playRound(attacker: Player, defender: Player) {
        ...
        fighterT1.weapon.changeArm()
        print("[\(fighterT1.pseudo)] your new arm :\(fighterT1.weapon.name) -> \(fighterT1.pseudo) attack⚡️")
        fighterT2.lifePoint -= fighterT1.weapon.damage
        print("[\(fighterT1.pseudo)]:\(fighterT1.life())  VS  [\(fighterT2.pseudo)]: \(fighterT2.life())")
    ...
    private func score(round: Int, ftr1: Fighter, ftr2: Fighter) -> [String] {
